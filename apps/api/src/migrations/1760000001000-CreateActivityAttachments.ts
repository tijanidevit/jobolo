...
export class CreateActivityAttachments1760000001000 implements MigrationInterface {
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(new Table({
      ...
      columns: [
        { name: 'id', type: 'varchar', length: '36', isPrimary: true, generationStrategy: 'uuid', isGenerated: true },
      ...
      foreignKeys: [{ columnNames: ['activityId'], referencedTableName: 'opportunity_activities', referencedColumnNames: ['id'], onDelete: 'CASCADE' }],
    }), true);
  }
